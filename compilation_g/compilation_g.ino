...
void followLine(){ 
  ...
  // Calculate the error
  error = calculateError(leftIRValue, rightIRValue); //midIRValue, 
...
float calculateError(int leftIRValue, int rightIRValue) { //int midIRvalue, 
  ...
  float sum = leftIRValue + rightIRValue; //+ midIRValue 
